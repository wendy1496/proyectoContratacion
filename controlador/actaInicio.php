...
$con=new Conexion();
  ...
  if($con){    
    ...
    if ($fila=$consulta->fetch(PDO::FETCH_ASSOC)){ 
        ...
        $textoCDP = "Además, contará con gastos de desplazamiento para el cumplimiento de sus obligaciones contractuales en caso de requerirlos y deberá legalizarlos de acuerdo al procedimiento institucional.";
    ...
    $numCDP = $fila['numCDP'];
    $rolD = $fila['rolD'];
    $identificacionSup = $fila['identificacion'];
    ...
    $TBS->MergeField('pro.identificacionSup', $identificacionSup);
