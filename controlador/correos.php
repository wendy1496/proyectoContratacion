<?php
session_start(); 
$infoContratos_id = $_GET['infoContratos_id'];
$correo = $_POST['correo'];
$nombreContrato = $_POST['nombreContrato'];
$honorarios = $_POST['honorarios'];
$cantidadPersonas = $_POST['cantidadPersonas'];
$perfil = $_POST['perfil'];
$objetoContratar = $_POST['objetoContratar'];
$fechaApertura = $_POST['fechaApertura'];
$medioPublicacion = $_POST['medioPublicacion'];
$fechaCierre = $_POST['fechaCierre'];
$fechaPublicacion = $_POST['fechaPublicacion'];

$asunto = "Invitación a participar en preselección";
$header = "Datos de la convocatoria";
...
include_once 'conexion.php';
  ...
  $con=$con->conectar();
    if($con){  
          $sql="UPDATE tblInfoContratos SET estado = 'Enviado'  WHERE infoContratos_id='$infoContratos_id'";
          $consulta=$con->prepare($sql);
          $consulta->execute();
          header('Location: ../template/views/respuesta.php?mensaje=actualizado');         
       }       

header('Location: ../template/views/enviarCorreo.php?mensajeCorreo=enviado');       
